  ...
  return (
    <header className="sticky top-0 p-4 grid grid-cols-[auto_1fr_auto] gap-2 bg-white z-10 border-b-2">
      ...
      <section className="grid grid-cols-[auto_1fr] gap-2 place-content-center">
        ...
        <section className="shadow-sm transition-colors border border-input rounded-3xl max-w-[700px] px-2 flex items-center focus-within:ring-1 focus-within:ring-primary">
          <Input
            type="search"
            value={search}
      ...
      <section className="flex items-center gap-2">
        <section className="relative size-10 flex bg-blue-600 rounded-full text-white">
          {items.length > 0 ? (
